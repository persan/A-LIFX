package LIFX.Messages.GetWifiInfo_Messages is
   ...
   overriding function Constructor (Params : not null access Ada.Streams.Root_Stream_Type'Class) return GetWifiInfo_Message;

   overriding procedure Initialize (Msg : in out GetWifiInfo_Message);
