...
package body LIFX.Messages.Lights.SetColor_Messages is
   ...
   -- Constructor --
   -----------------
   overriding procedure Initialize (Msg : in out SetColor_Message) is
   begin
   ...
   overriding function Constructor (Params : not null access Ada.Streams.Root_Stream_Type'Class) return SetColor_Message is
   ...
   function Create (Color : HSBK_Type; Duration : Standard.Duration) return SetColor_Message is
   begin
      return Ret : SetColor_Message do
         Ret.Color                             := Color;
