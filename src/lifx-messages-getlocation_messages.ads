package LIFX.Messages.GetLocation_Messages is
   ...
   overriding function Constructor (Params : not null access Ada.Streams.Root_Stream_Type'Class) return GetLocation_Message;
   overriding procedure Initialize (Msg : in out GetLocation_Message);
