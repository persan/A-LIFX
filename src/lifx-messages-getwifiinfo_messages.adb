...
package body LIFX.Messages.GetWifiInfo_Messages is
   ...
   overriding procedure Initialize (Msg : in out GetWifiInfo_Message) is
   begin
   ...
   overriding function Constructor (Params : not null access Ada.Streams.Root_Stream_Type'Class) return GetWifiInfo_Message is
