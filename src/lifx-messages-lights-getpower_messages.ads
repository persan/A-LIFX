package LIFX.Messages.Lights.GetPower_Messages is
   ...
   overriding function Constructor (Params : not null access Ada.Streams.Root_Stream_Type'Class) return GetPower_Message;
   overriding procedure Initialize (Msg : in out GetPower_Message);
