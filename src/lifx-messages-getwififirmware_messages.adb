...
package body LIFX.Messages.GetWifiFirmware_Messages is
   ...
   overriding procedure Initialize (Msg : in out GetWifiFirmware_Message) is
   begin
   ...
   overriding function Constructor (Params : not null access Ada.Streams.Root_Stream_Type'Class) return GetWifiFirmware_Message is
