package LIFX.Messages.GetVersion_Messages is
   ...
   overriding function Constructor (Params : not null access Ada.Streams.Root_Stream_Type'Class) return GetVersion_Message;

   overriding procedure Initialize (Msg : in out GetVersion_Message);
