...
package body LIFX.Messages.GetLocation_Messages is
   ...
   -- Constructor --
   -----------------
   overriding procedure Initialize (Msg : in out GetLocation_Message) is
   begin
   ...
   overriding function Constructor (Params : not null access Ada.Streams.Root_Stream_Type'Class) return GetLocation_Message is
