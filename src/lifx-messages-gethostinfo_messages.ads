package LIFX.Messages.GetHostInfo_Messages is
   ...
   overriding function Constructor (Params : not null access Ada.Streams.Root_Stream_Type'Class) return GetHostInfo_Message;

   overriding procedure Initialize (Msg : in out GetHostInfo_Message);
