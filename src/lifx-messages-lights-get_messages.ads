package LIFX.Messages.Lights.Get_Messages is
   ...
   overriding function Constructor (Params : not null access Ada.Streams.Root_Stream_Type'Class) return Get_Message;
   overriding procedure Initialize (Msg : in out Get_Message);
