package LIFX.Messages.GetService_Messages is
   ...
   overriding function Constructor (Params : not null access Ada.Streams.Root_Stream_Type'Class) return GetService_Message;

   overriding procedure Initialize (Msg : in out GetService_Message);
