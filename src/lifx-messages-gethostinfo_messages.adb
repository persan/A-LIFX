...
package body LIFX.Messages.GetHostInfo_Messages is
   ...
   overriding procedure Initialize (Msg : in out GetHostInfo_Message) is
   begin
   ...
   overriding function Constructor (Params : not null access Ada.Streams.Root_Stream_Type'Class) return GetHostInfo_Message is
