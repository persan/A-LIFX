...
package body LIFX.Messages.GetGroup_Messages is
   ...
   overriding procedure Initialize (Msg : in out GetGroup_Message) is
   begin
   ...
   overriding function Constructor (Params : not null access Ada.Streams.Root_Stream_Type'Class) return GetGroup_Message is
